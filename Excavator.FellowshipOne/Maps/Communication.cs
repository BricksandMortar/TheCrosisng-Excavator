                    ...
                    if ( peopleToUpdate.Any() && !string.IsNullOrWhiteSpace( value ) )
                    {
                        ...
                        else
                        {
                            ...
                            if ( person != null )
                            {
                                ...
                                else if ( value.IsEmail() && type == F1_PRIMARY_EMAIL && ( string.IsNullOrWhiteSpace(person.Email) || !person.Email.Equals( value )) && !person.Attributes.ContainsKey( SecondaryEmailAttribute.Key ) )
                                {
